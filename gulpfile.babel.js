...
const PATH_SASS = ['node_modules/@undp/design-system/stories','node_modules/@undp/design-system/docs/css'];
const PATH_JS = 'src/assets/js/app.js';
const CDN = 'https://cdn.jsdelivr.net/npm/@undp/design-system-assets@1.2/';
const PORT = 8000;
